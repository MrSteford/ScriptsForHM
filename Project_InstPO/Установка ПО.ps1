...
$apps = @{
    ...
    "Ubisoft Connect" = "https://ubistatic3-a.akamaihd.net/orbit/launcher_installer/UbisoftConnectInstaller.exe"
    "GOG GALAXY" = "https://cdn.gog.com/open/galaxy/client/galaxy_client_2.0.33.7.exe"
    "Opera GX" = "https://get.geo.opera.com/pub/opera_gx/81.0.4196.68/win/Opera_GX_81.0.4196.68_Setup.exe"
    "twinkle Tray" = "https://www.microsoft.com/en-us/p/twinkle-tray/9nblggh4s4s6"
